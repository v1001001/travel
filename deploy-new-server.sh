...
echo "🎉 部署完成！"
echo "🌐 网站地址: http://8.155.160.129"
echo "📱 主页面: http://8.155.160.129/index.html"
echo "🗺️ 东北呼伦贝尔: http://8.155.160.129/northeast-hulunbeier-travel.html"
echo "🌊 黑龙江深度游: http://8.155.160.129/heilongjiang-travel-enhanced.html"
echo "⚡ 东三省7天: http://8.155.160.129/kmTravel.html"
